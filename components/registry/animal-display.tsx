...
import { FaDog, FaRegCalendar } from "react-icons/fa6";
...
const AnimalDisplay = ({
  ...
  animal: AnimalWithPhotos | AnimalReportWithPhotos;
}) => {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="text-center">
            ...
            <h3 className="mt-4 text-lg font-semibold text-gray-900">Breed</h3>
